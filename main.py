...
#excelente
#garrafa_boa
image_path = 'D:\\PythonProjects\\projeto-cv2\\intervenção_praça_migrantes\\boa_plastico2.jpg'
...
# Define o limite de confiança (10%)
...
screen_width = 1920  # Substitua pelo valor da largura da tela
screen_height = 1080  # Substitua pelo valor da altura da tela
...
# Cria uma janela com o tamanho da imagem redimensionada
cv2.namedWindow("Tela", cv2.WINDOW_NORMAL)
cv2.resizeWindow("Tela", new_w, new_h)
